 ...
 * 
 * Starts CLOSED. If a "surge" or error threshold is reached then it will OPEN.
 * While OPEN allow() will fail till timeout has been reached. Once reached it
 * will go HALF-OPEN and allow one try If successful() will go fully CLOSED else
 * back to OPEN.
 * 
 */
