...
public class CaOutputStream extends OutputStream {
    ...
    private Logger logger = LoggerFactory.getLogger(CaOutputStream.class);
    ...
    public CaOutputStream(Configuration conf, CaFileSystemStore store, Path path, FsPermission perms,
