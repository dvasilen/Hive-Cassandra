...
public class CassandraHiveRecordReader extends RecordReader<BytesWritable, MapWritable>
    ...
    private Iterator<Map.Entry<ByteBuffer, Cell>> columnIterator = null;
    private Map.Entry<ByteBuffer, Cell> currentEntry;
    private Iterator<Cell> subColumnIterator = null;
        ...
        if (isTransposed) {
            ...
            while (true) {
                ...
                if (next) {
                    ...
                    currentValue.clear();
                    Map.Entry<ByteBuffer, Cell> entry = currentEntry;
    ...
    private void populateMap(SortedMap<ByteBuffer, Cell> cvalue, MapWritable value) {
        for (Map.Entry<ByteBuffer, Cell> e : cvalue.entrySet()) {
